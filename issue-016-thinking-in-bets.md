...
Don't just read the frameworks — **install them.** We distilled Duke's decision toolkit (resulting, decisions-as-bets, calibrated confidence, truthseeking pods, CUDOS, and mental time travel) into an installable AI skill, so your assistant can apply *Thinking in Bets* to your real decisions **and** your agent fleet on demand.

**[⤓ Get the Thinking in Bets skill](https://github.com/hooperalex/managing-machines/tree/main/skills/thinking-in-bets)**
