...
*Procedure:* first diverge — multiply options without judging (brainstorm rules: defer
judgment, encourage wild ideas, build on others' ideas, stay on topic); then converge — make
decisive choices. Never collapse the two. *Use when* a team jumps to the first idea or can't
decide.
