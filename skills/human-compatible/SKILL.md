...
5. **Build corrigibility.** Add an interruption path the system is incentivized to respect;
   require human confirmation before irreversible actions; humans own the off-switch.
